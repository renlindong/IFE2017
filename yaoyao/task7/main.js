    ...
    table.init = function () {
        ...
        for (let index = 0, length = config.length; index < length; index++) {
            ...
            if (config[index].needSort) {
                ...
                triangleUp.addEventListener('click', this.sortUp.bind(this), false)
                ...
                triangleDown.addEventListener('click', this.sortDown.bind(this), false)
